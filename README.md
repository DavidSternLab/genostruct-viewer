...
hardcoded. It needs three inputs:
...
```bash
python pipeline/genostruct.py \
  --genome path/to/genome.fa --gff path/to/annotation.gff3 \
  --pdb-dir path/to/pdbs --out viewer
```
...
## Web app (upload your own data, no local setup)
